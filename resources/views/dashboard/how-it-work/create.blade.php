      ...
      <div class="col-sm-12 col-md-10 col-lg-8 col-xl-8">
        <div class="card">
            <div class="card-header">
              <i class="fa fa-align-justify"></i> {{ __('Create How It Works') }}</div>
            <div class="card-body">
            @if ($errors->any())
            ...
            @endif
                <form method="POST" action="{{ route('how-it-works.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <textarea class="form-control" id="textarea-input" name="desc" rows="6" placeholder="{{ __('Description..') }}" required></textarea>
                    </div>
