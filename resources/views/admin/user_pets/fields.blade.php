...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('gender', [], null, ['class' => 'form-control select2']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('weight', [], null, ['class' => 'form-control select2']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('admin.user-pets.index') !!}" class="btn btn-default">Cancel</a>
</div>