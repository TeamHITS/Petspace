					...
					<div class="service-menu-card service-menu-card-3 sub-menu-card-1">
						<div class="top">
							<div class="text">
								...
								<p class="price">AED {{ $service['price'] }} <span class="cut-price">{{($service['discount'] > 0 )? "AED ".($service['price'] - $service['discount'] ): ""}} </span>• Duration: {{ $service['service_duration'] }}mins</p>
							</div>
							<div class="img">
