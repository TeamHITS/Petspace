                            ...
                            <div class="service-menu-card service-menu-card-1">
                                ...
                                <div class="button-box">
                                    <a id="publish-btn" style="cursor: pointer" class="gen-btn"><img
                                                src="{{ url('public/assets/images/icon-upload.png') }}"
                                                class="img-fluid">Publish changes</a>
                                </div>
                            </div>
                                            ...
                                            <div class="text">
                                                ...
                                                @else
                                                    <p class="price">
                                                        ...
                                                        Duration: {{$service['service_duration']}}mins</p>
                                                @endif
                                                <a href="{{URL::to('/submenu').'/'.$service['id']}}" class="sub-menu">View
                                                    Submenu <i class="fas fa-arrow-right"></i></a>
                                            </div>
                                            <div class="img">
