                ...
                <div class="start-order-wrap mb-4">
                    ...
                    <div class="start-order-card">
                        ...
                        <div class="card-actions">
                            <a href="http://www.google.com/maps/place/{{$order["address"]["latitude"]}},{{$order["address"]["longitude"]}}"
                               target="_blank" class="pill">Get Directions</a>
                            <a href="{{URL::to('/technician/start-order')."/".$order["id"]."/".\App\Models\Order::AT_LOCATON}}"
                               class="pill colored-pill">At the location</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="start-order-wrap mb-4">
                    ...
                    <div class="start-order-card">
                        ...
                        <div class="card-actions">
                            ...
                            <a href="{{URL::to('/technician/start-order')."/".$order["id"]."/".\App\Models\Order::SERVICE_IN_PROGRESS}}"
                               class="pill colored-pill">Begin Service</a>
                        </div>
                    </div>
                </div>
            @elseif($order['progress_status'] > 20)
            ...
            @elseif($order['progress_status'] == 30)
                <div class="start-order-wrap mb-4">
                    ...
                    <div class="start-order-card">
                        ...
                        <div class="card-actions">
                            <a href="{{URL::to('/technician/start-order')."/".$order["id"]."/".\App\Models\Order::SREVICE_COMPLETED}}"
                               class="pill colored-pill">Service Complete</a>
                        </div>
                    </div>
                </div>
            @elseif($order['progress_status'] > 30)
