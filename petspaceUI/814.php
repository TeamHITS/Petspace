			...
			<div class="container">
				<div class="service-menu-card-wrap">
					...
					<div class="service-menu-card service-menu-card-3 service-menu-card-4">
						<div class="top">
							<div class="text w-100">
								<p class="name">Small<a class="mr-1" href="#!"><i class="fas fa-pencil-alt"></i></a></p>
								<p>Shampoo wash + Blow dry, Brush, Trim Nails,Clean Ears,Spray Colonge, Anal Gland .Lorem ipsum dolor sit amet.</p>
								<p class="price">AED 160.00 • Duration: 30mins</p>
							</div>
						</div>
					...
					<div class="service-menu-card service-menu-card-3 service-menu-card-4">
						<div class="top">
							<div class="text w-100">
								<p class="name">Medium<a class="mr-1" href="#!"><i class="fas fa-pencil-alt"></i></a></p>
								<p>Shampoo wash + Blow dry, Brush, Trim Nails,Clean Ears,Spray Colonge, Anal Gland .Lorem ipsum dolor sit amet.</p>
								<p class="price">AED 160.00 • Duration: 30mins</p>
							</div>
						</div>
					...
					<div class="service-menu-card service-menu-card-3 service-menu-card-4">
						<div class="top">
							<div class="text w-100">
								<p class="name">Large<a class="mr-1" href="#!"><i class="fas fa-pencil-alt"></i></a></p>
								<p>Shampoo wash + Blow dry, Brush, Trim Nails,Clean Ears,Spray Colonge, Anal Gland .Lorem ipsum dolor sit amet.</p>
								<p class="price">AED 160.00 • Duration: 30mins</p>
							</div>
						</div>
					...
					<div class="service-menu-card service-menu-card-3 service-menu-card-4">
						<div class="top">
							<div class="text w-100">
								<p class="name">Cat<a class="mr-1" href="#!"><i class="fas fa-pencil-alt"></i></a></p>
								<p>Shampoo wash + Blow dry, Brush, Trim Nails,Clean Ears,Spray Colonge, Anal Gland .Lorem ipsum dolor sit amet.</p>
								<p class="price">AED 160.00 • Duration: 30mins</p>
							</div>
						</div>
					...
					<div class="service-menu-card sub-menu-card-3">
						<div class="text">
							<p class="title">Addons<a class="mr-1" href="#!"><i class="fas fa-pencil-alt"></i></a></p>
							<p>This is a subheading or can be instructions for users</p>
						</div>
						<div class="bottom">
							<p><span class="mr-1">• Optional Items</span>  <span class="mr-1">• Minimum 01 Item</span>  <span class="mr-1">• Maximum 05 Items</span></p>
					...
					<div class="service-menu-card service-menu-card-3 service-menu-card-4">
						<div class="top">
							<div class="text w-100">
								<p class="name">Addon 1<a class="mr-1" href="#!"><i class="fas fa-pencil-alt"></i></a></p>
								<p>Shampoo wash + Blow dry, Brush, Trim Nails,Clean Ears,Spray Colonge, Anal Gland .Lorem ipsum dolor sit amet.</p>
								<p class="price">AED 160.00 • Duration: 30mins</p>
							</div>
						</div>
					...
					<div class="service-menu-card service-menu-card-3 service-menu-card-4">
						<div class="top">
							<div class="text w-100">
								<p class="name">Addon 2<a class="mr-1" href="#!"><i class="fas fa-pencil-alt"></i></a></p>
								<p>Shampoo wash + Blow dry, Brush, Trim Nails,Clean Ears,Spray Colonge, Anal Gland .Lorem ipsum dolor sit amet.</p>
								<p class="price">AED 160.00 • Duration: 30mins</p>
							</div>
						</div>
					...
					<div class="service-menu-card service-menu-card-3 service-menu-card-4">
						<div class="top">
							<div class="text w-100">
								<p class="name">Addon 3<a class="mr-1" href="#!"><i class="fas fa-pencil-alt"></i></a></p>
								<p>Shampoo wash + Blow dry, Brush, Trim Nails,Clean Ears,Spray Colonge, Anal Gland .Lorem ipsum dolor sit amet.</p>
								<p class="price">AED 160.00 • Duration: 30mins</p>
							</div>
						</div>
