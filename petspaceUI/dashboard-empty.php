				...
				<div class="row">
					<div class="col-lg-8 col-md-9 co-sm-12">
						<div class="shadow-card slider-card-wrap mb-4">
							...
							<div class="empty-active-dash-card">
								<div>
									<p class="heading">Lorem ipusm</p>
						...
						<div class="shadow-card slider-card-wrap">
							...
							<div class="scheduled-empty-dash-card">
								<div>
									<p class="heading">No Upcoming Orders</p>
									<p class="">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation</p>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4 col-md-3 co-sm-12">
						<div class="shadow-card slider-card-wrap h-100">
							...
							<div class="new-order-empty-dash-card">
								<div class="text-center">
									<p class="heading">No New Orders</p>
									<p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation</p>
									<a href="#!" class="gen-btn">Add Technician</a>
								</div>
							</div>							
						</div>
					</div>
						...
						<div class="row">
							...
							<div class="col-lg-8 col-md-8 col-sm-12">
								<div class="shadow-card mb-3">
									<div class="order-number-info">
										<p class="number">Order #1234</p>
										<p class="status"><span class="tag scheduled"></span>Schedule</p>
									</div>
								</div>
								<div class="shadow-card mb-3">
									<div class="order-instrustion">
