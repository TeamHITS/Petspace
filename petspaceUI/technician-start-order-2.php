...
<div class="technician-dashboard-wrap">
	<section class="technician-dash-top auth-top">
		<a href="technician-home.php" class="pg-title"><i class="fas fa-chevron-left mr-1"></i> Order #7363523</a>
		<a href="#!" class="call-bth"><i class="fas fa-phone-alt"></i></a>
	</section>
		...
		<div class="start-order-wrap mb-4 completed-service">
			...
			<div class="start-order-card">
				...
				<div class="card-actions">
					<a href="#!" class="pill">Get Directions</a>
					<a href="#!" class="pill colored-pill">At the location</a>
				</div>
			</div>
		</div>
