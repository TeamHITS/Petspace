						...
						<div class="shadow-card slider-card-wrap mb-4">
							<div class="slider-wrap-top">
								...
								<div class="slider-nav active-order-nav">
									...
									<p><span>1</span> out of <span>2</span></p>
										...
										<div class="slider-card-body">
											<div class="slider-card">
												<div class="slider-card-top">
													...
													<a href="#!" data-bs-toggle="modal" data-bs-target="#active-order-modal" class="edit"><i class="far fa-edit"></i></a>
												</div>
									...
									<div class="swiper-slide">
										<div class="slider-card-body">
											<div class="slider-card">
												<div class="slider-card-top">
													<p class="order-no">Order #1234</p>
													<a href="#!" class="edit" data-bs-toggle="modal" data-bs-target="#schedule-order-modal"><i class="far fa-edit"></i></a>
												</div>
												<div class="order-info">
													<div class="order-info-detail-wrap">
														<div class="order-info-detail">
