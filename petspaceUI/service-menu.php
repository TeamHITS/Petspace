			...
			<div class="container">
				<div class="service-menu-card-wrap">
					...
					<div class="service-menu-card service-menu-card-1 full-text">
						<div class="text">
							<p class="title">Basic Packages</p>
					...
					<div class="service-menu-card service-menu-card-3">
						<div class="top">
							<div class="text">
								...
								<a href="service-sub-menu.php" class="sub-menu">View Submenu <i class="fas fa-arrow-right"></i></a>
							</div>
							<div class="img">
					...
					<div class="service-menu-card service-menu-card-3">
						<div class="top">
							<div class="text">
								<p class="name">Bath & Brush (Package II)</p>
								<p>Shampoo wash + Blow dry, Brush, Trim Nails,Clean Ears,Spray Colonge, Anal Gland .Lorem ipsum dolor sit amet.</p>
								<p class="price">AED 160.00 • Duration: 30mins</p>
								<a href="service-sub-menu.php" class="sub-menu">View Submenu <i class="fas fa-arrow-right"></i></a>
							</div>
					...
					<div class="service-menu-card service-menu-card-3">
						<div class="top">
							<div class="text">
								<p class="name">Bath & Brush (Package III)</p>
								<p>Shampoo wash + Blow dry, Brush, Trim Nails,Clean Ears,Spray Colonge, Anal Gland .Lorem ipsum dolor sit amet.</p>
								<p class="price">AED 160.00 • Duration: 30mins</p>
								<a href="service-sub-menu.php" class="sub-menu">View Submenu <i class="fas fa-arrow-right"></i></a>
							</div>
					...
					<div class="service-menu-card service-menu-card-3">
						<div class="top">
							<div class="text">
								...
								<p>Shampoo wash + Blow dry, Brush, Trim Nails,Clean Ears,Spray Colonge, Anal Gland .Lorem ipsum dolor sit amet.</p>
								<p class="price">AED 30.00 <span class="cut-price">AED 40.00</span>• Duration: 30mins</p>
								<a href="service-sub-menu.php" class="sub-menu">View Submenu <i class="fas fa-arrow-right"></i></a>
							</div>
							<div class="img">
					...
					<div class="service-menu-card service-menu-card-3">
						<div class="top">
							<div class="text">
								<p class="name">Teeth Stain Cleaning</p>
								<p>Shampoo wash + Blow dry, Brush, Trim Nails,Clean Ears,Spray Colonge, Anal Gland .Lorem ipsum dolor sit amet.</p>
								<p class="price">AED 30.00 <span class="cut-price">AED 40.00</span>• Duration: 30mins</p>
								<a href="service-sub-menu.php" class="sub-menu">View Submenu <i class="fas fa-arrow-right"></i></a>
							</div>
